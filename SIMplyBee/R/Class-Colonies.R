...
#' @param i integer, numeric, logical, or character, index or name to select
...
#' @describeIn Colonies-class Extract a colony (one or more!) by index (return \code{\link{Colonies-class}})
setMethod(f = "[",
...
#' @describeIn Colonies-class Extract a colony (one or more!) by name (character) (return \code{\link{Colonies-class}})
setMethod(f = "[",
...
#' @describeIn Colonies-class Extract a colony (just one!) by index (numeric) (return \code{\link{Colony-class}})
setMethod(f = "[[",
...
#' @describeIn Colonies-class Extract a colony (just one!) by name (character) (return \code{\link{Colony-class}})
setMethod(f = "[[",
          signature(x = "Colonies", i = "character"),
          function(x, i) {
            n <- length(i)
