...
colonies within it are `proper`, meaning they contain some individuals, how many
are `empty` and contain no individuals, how many are `NULL` objects, how many
have experienced a split, swarm, supersedure, or a collapse (you can read more
about this events in the Colony events vignette), and how many of them are
