...
Another argument you can use with this function is `collapse = TRUE/FALSE`. If `collapse = TRUE` then all of the information is squished together and a single matrix is returned, if `collapse = FALSE` we return a list by caste or by colony.  
