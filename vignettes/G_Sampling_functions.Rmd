...
argument can accept these sampling functions as input, meaning that the output
of such function calls will be stochastic. These functions are useful when you
want to sample a variable number of individuals around a mean, as for example
when mating virgin queens.
...
additional function, `splitPColonyStrength()`, that determined the number of
